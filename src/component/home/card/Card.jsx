    ...
    <div className={styles.Card}>
      ...
      <div className={styles.topContainer}>
        ...
        <div className={styles.box}>
          ...
          <div className={styles.Line}>
            This part of the Salesforce platform is focused <br /> on providing support and help to the customers. This<br /> helps in retaining the customers, <br /> increasing their satisfaction and loyalty.
          </div>
          <div className={styles.Button}>Read More</div>
        </div>
        ...
        <div className={styles.box}>
          ...
          <div className={styles.Line}>
            Data science and machine learning are two concepts that<br /> fall within the field of technology and<br /> using data to further how we create and innovate<br /> products, services, infrastructural systems,
          </div>
          <div className={styles.Button}>Read More</div>
        </div>
        ...
        <div className={styles.box}>
          ...
          <div className={styles.Line}>
            With RPA, software users create software robots,<br /> or “bots”, that can learn, mimic, and then execute<br /> rules-based business processes.
          </div>
          <div className={styles.Button}>Read More</div>
        </div>
      ...
      <div className={styles.Container3}>
        <div className={styles.box}>
          ...
          <div className={styles.Line}>
          Java is a programming language and<br/> computing platform first released by Sun<br/>
